...
function main() {
  ...
  const partnerNames = ['Silva', 'Sara', 'Anna', 'Emilia', 'Maria'];
  const locations = ['Amsterdam', 'Paris', 'London', 'Madrid', 'New york'];
  const jobTitles = ['Teacher', 'Doctor', 'Engineer', 'Web developer', 'Actor'];

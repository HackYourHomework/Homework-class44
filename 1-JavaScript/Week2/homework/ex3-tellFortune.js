...
function main() {
  ...
  const partnerNames = ['Tony', 'Sarah', 'Kate', 'John', 'Jennifer'];

  const locations = ['Amsterdam', 'Haarlem', 'Milan', 'Barcelona', 'Paris'];

  const jobTitles = ['Doctor', 'Engineer', 'Chemist', 'Teacher', 'Nurse'];

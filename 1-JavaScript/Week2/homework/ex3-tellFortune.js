...
function main() {
  ...
  const partnerNames = ['Olivia', 'Sophia', 'Ava', 'Isabella', 'Mia'];

  const locations = ['New York', 'London', 'Paris', 'Istanbul', 'Sidney'];

  const jobTitles = ['developer', 'designer', 'manager', 'teacher', 'writer'];
